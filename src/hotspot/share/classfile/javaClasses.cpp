...
bool java_lang_String::equals(oop java_string, const jchar* chars, int len) {
  assert(java_string->klass() == vmClasses::String_klass()
          || (VM_EnhancedRedefineClassesHelper::is_inside_redefinition() && java_string->klass()->newest_version() == vmClasses::String_klass()),
         "must be java_string");
...
oop java_lang_Class::primitive_mirror(BasicType t) {
  ...
  assert(mirror != NULL && (mirror->is_a(vmClasses::Class_klass())
    || (VM_EnhancedRedefineClassesHelper::is_inside_redefinition() && vmClasses::Class_klass()->old_version() != NULL && mirror->is_a(vmClasses::Class_klass()->old_version()))), "must be a Class");
